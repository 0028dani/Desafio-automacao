class LeBiscuitElements {
    ...
    CEPfrete = () => {return '.vtex-address-form-4-x-input'}
    Calcular = () => {return '.vtex-store-components-3-x-shippingContainer > .vtex-button > .vtex-button__label'}
    Adicionar = () => {return '.mt4 > .pr0 > .vtex-button > .vtex-button__label'}
